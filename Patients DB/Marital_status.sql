...
--Insert into dbo.Patients values('Nath', 'Male','Patna','A-ve','Shivam@nath.com','9431000357','RAJ',2,25,'Married','Peanut')

--DBCC CHECKIDENT ('Patients', RESEED, 0);

/* CREATE TABLE MaritalStatusOptions (
    ID INT PRIMARY KEY IDENTITY(1,1),
    Status NVARCHAR(50) NOT NULL UNIQUE
);
*/

--drop table MaritalStatusOptions